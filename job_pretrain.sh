...
# # # # ------- Training -------
# python train.py --grammar $SUBGRAMMAR_TRAIN --dataset_name "${DATASET_SIZE}_${SUPERGRAMMAR_SYMBOL}" --model $MODEL --num_epochs 3

# python train.py --grammar $SUPERGRAMMAR \
#     --dataset_name "${DATASET_SIZE}_${SUPERGRAMMAR_SYMBOL}" \
#     --model $MODEL \
#     --continue_training \
#     --checkpoint_path "${SUBGRAMMAR_TRAIN}/${SUBGRAMMAR_TRAIN}_${DATASET_SIZE}_${SUPERGRAMMAR_SYMBOL}/${MODEL}/new/seed_42/epoch_3_0.pt" \
#     --num_epochs $TO_EPOCH \
#     --continue_from 3
