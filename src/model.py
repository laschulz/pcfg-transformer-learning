...
class CausalSelfAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        # to catch attention hooks
        self.record_attn = getattr(config, "record_attn", False)
        self.last_attn = None  
    def forward(self, x):
        ...
        if self.flash:
            ...
            if self.record_attn and not self.training:
...
class GPT(nn.Module):
    ...
    def train_model(self, data_dir, dataset, num_epochs, batch_size,
        ...
        ckpt_path = os.path.join(data_dir, dataset, config, train_type, f'seed_{seed}')
    ...
    def generate(self, idx, max_new_tokens, eos_token_id, eos_prob_threshold, temperature=1.0, top_k=None, greedy = False):
        ...
        for _ in range(max_new_tokens):
            ...
            print(idx_cond) #TODO: remove this again
